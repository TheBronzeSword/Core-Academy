...
function StartPlayerDisarming(trigger, player)
	...
	Events.Broadcast("Spike_Starting_Disarm") 
	...
	disarmTask = Task.Spawn(function()
		...
		Events.Broadcast("Spike_Disarmed")
...
function StopPlayerDisarming()
	...
	Events.Broadcast("Spike_Cancel_Disarm")
	Events.BroadcastToAllPlayers("Spike_Cancel_Disarm", player)
